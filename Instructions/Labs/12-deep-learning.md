...
1. In a new browser tab, open the [deep-learning.pysb](https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/deep-learning.pysb){:target="_blank"} notebook at `https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/deep-learning.pysb` and save it on your local computer - be sure to save it as as **deep-learning.pysb**, <u>not</u> *deep-learning.pysb.**txt***.
