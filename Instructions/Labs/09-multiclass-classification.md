...
1. In a new browser tab, open the [multiclass-classification.pysb](https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/multiclass-classification.pysb){:target="_blank"} notebook at `https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/multiclass-classification.pysb` and save it on your local computer - be sure to save it as as **multiclass-classification.pysb**, <u>not</u> *multiclass-classification.pysb.**txt***.
