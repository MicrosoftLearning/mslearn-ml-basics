...
1. In a new browser tab, open the [numpy-pandas.pysb](https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/numpy-pandas.pysb){:target="_blank"} notebook at `https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/numpy-pandas.pysb` and save it on your local computer - be sure to save it as as **numpy-pandas.pysb**, <u>not</u> *numpy-pandas.pysb.**txt***.
