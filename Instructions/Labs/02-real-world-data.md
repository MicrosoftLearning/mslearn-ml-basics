...
1. In a new browser tab, open the [real-world-data.pysb](https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/real-world-data.pysb){:target="_blank"} notebook at `https://microsoftlearning.github.io/mslearn-ml-basics/Labfiles/real-world-data.pysb` and save it on your local computer - be sure to save it as as **real-world-data.pysb**, <u>not</u> *real-world-data.pysb.**txt***.
